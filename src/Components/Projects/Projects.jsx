...
const Projects = () => {
  ...
  return (
    <div className="projects" id="Projects">
      <span style={dark ? { color: "white" } : { color: "" }}>
        My Recent Projects
      </span>
      <Swiper
        spaceBetween={8}
      ...
      >
        ...
        <SwiperSlide className="swiper-slide">
          <img src={Weather} alt="" className="Project-image" />
        </SwiperSlide>
        <SwiperSlide className="swiper-slide">
        ...
        <SwiperSlide className="swiper-slide">
          ...
          <div className="Links">
            <a href="https://github.com/Nikhil-0088/aoss" target="_blank">
              <img src={Github} alt="" className="link" />
            </a>
            <a href="https://nikhil-0088.github.io/aoss/" target="_blank">
              <img src={dark ? whitelink : Live} alt="" className="Live" />{" "}
            </a>
          </div>
        </SwiperSlide>
        <SwiperSlide className="swiper-slide">
          ...
          <div className="Links">
            <a
              href="https://github.com/Nikhil-0088/Student-Data-storage"
              target="_blank"
            >
              <img src={Github} alt="" className="link" />
            </a>
